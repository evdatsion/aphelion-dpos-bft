...
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/evdatsion/aphelion-dpos-bft/build -e CONFIGDIR=$GOPATH/src/github.com/evdatsion/aphelion-dpos-bft/networks/remote/ansible/mytestnet
...
ExecStart=/usr/bin node --proxy_app=kvstore --p2p.persistent_peers=$id0@$ip0:26656,$id1@$ip1:26656,$id2@$ip2:26656,$id3@$ip3:26656
