...
if __name__ == "__main__":
  ...
  parser.add_argument("--file", default="/tmp/workspace_{0}_{1}_{2}.zip".format(os.environ.get('CIRCLE_TAG'),os.environ.get('GOOS'),os.environ.get('GOARCH')), help="File to upload")
  ...
  result = request('uploads.github.com', '/repos/releases/{0}/assets?name={1}'.format(args.id, filename), mimetype, mimeencoding, asset)
